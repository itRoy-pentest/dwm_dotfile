...
static const char* rofi[] = { "rofi", "-show", "drun", "-theme", "~/.config/rofi-themes-collection/themes/rounded-nord-dark.rasi", NULL}; 
...
static const Key keys[] = {
    ...
    { MODKEY,                       XK_space,  spawn,          SHCMD("setxkbmap -query | grep -q 'layout:.*us' && setxkbmap ru || setxkbmap us") },

    /* Громкость (Pipewire/Wireplumber) */
    ...
    /* Яркость */
    { 0, XF86XK_MonBrightnessUp,   spawn, {.v = (const char*[]){ "brightnessctl", "set", "+20%", NULL } } },
    { 0, XF86XK_MonBrightnessDown, spawn, {.v = (const char*[]){ "brightnessctl", "set", "20%-", NULL } } },

    /* Скриншот области в файл и буфер обмена */
    { 0,          XK_Print,  spawn, SHCMD("flameshot gui --raw -p ~/Pictures/screenshots | xclip -selection clipboard -t image/png") },
